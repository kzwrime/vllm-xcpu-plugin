...
def test_silu_and_mul_xcpu_fallback_extended(
    ...
    setattr(torch_xcpu._C, "silu_and_mul_fp32", None)
    setattr(torch_xcpu._C, "silu_and_mul_bf16", None)
    ...
    # 恢复算子
    if original_fp32:
        setattr(torch_xcpu._C, "silu_and_mul_fp32", original_fp32)
    if original_bf16:
        setattr(torch_xcpu._C, "silu_and_mul_bf16", original_bf16)